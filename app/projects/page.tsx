...
export default function Projects() {
  ...
  return (
    ...
    image: '📝',
    date: '2023',
    github: 'https://github.com/amelie/blog',
    demo: 'https://amelie-blog.vercel.app',
    features: [
  ...
  },
  {
    ...
    title: 'Weather App',
    category: 'Application Mobile',
    description: 'Application météo élégante avec prévisions détaillées, cartes interactives et alertes personnalisées.',
    technologies: ['Flutter', 'OpenWeather API', 'Dart'],
    image: '🌤️',
    date: '2022',
    github: 'https://github.com/amelie/weather-app',
    demo: null,
    features: [
      'Prévisions 7 jours',
      'Cartes météo',
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Une sélection de projets qui démontrent mes compétences et ma passion
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                {/* Image/Icon Header */}
                <div className="bg-gradient-to-br from-primary-500 to-primary-700 p-12 text-center">
                  <div className="text-7xl mb-4 transform group-hover:scale-110 transition-transform duration-300">
                    {project.image}
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/20 backdrop-blur-sm
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.technologies.map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 bg-primary-50 text-primary-700 text-xs font-medium
                  ...
                  <div className="flex gap-3">
                    ...
                    {project.demo && (
                      <a
                        ...
                        rel="noopener noreferrer"
                        className="flex-1 flex items-center justify-center gap-2 px-4 py-2
                                 bg-primary-600 text-white rounded-lg font-medium text-sm
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-primary-100 mb-8 leading-relaxed">
              Je suis toujours ouverte à de nouveaux projets et collaborations.
